...
SELECT 
    ...
    (SELECT COUNT(*) FROM evaluation_feedback_ratings WHERE evaluation_type = 'writing') as writing_feedback_count,
    (SELECT COUNT(*) FROM evaluation_feedback_ratings WHERE evaluation_type = 'speaking') as speaking_feedback_count;
